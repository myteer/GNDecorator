...
public class GNDecorator {
    ...
    private final ImageView viewMinimize    = new ImageView(new Image(getClass().getResource("/img/minimize.png").toExternalForm()));
    private final ImageView viewMaximize    = new ImageView(new Image(getClass().getResource("/img/maximize.png").toExternalForm()));
