...
public class GNFullscreen extends Button  {
    ...
    private final ImageView viewFullScreen = new ImageView(new Image(getClass().getResource("/img/fullscreen.png").toExternalForm()));
    private final ImageView viewUnFullScreen = new ImageView(new Image(getClass().getResource("/img/unfullscreen.png").toExternalForm()));
